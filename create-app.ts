...
import {  pull, tryGitInit } from "./helpers/git";
  ...
  if (example) {
    ...
    const packageJson = {
      ...
      scripts: {
        ...
        "prebuild-storybook":
          "npm run clean && hugo --gc --environment storybook",
        ...
        "cf:docs":
          "migrations doc -e master -p docs/contentful --template contentful-docs.js",
      },
      migrations: {
        storage: "content",
    ...
    const tempDir = await pull('git@github.com:jungvonmatt/karate-kit.git');
    console.log(tempDir);
