...
export function hasExample(name: string): Promise<boolean> {
  return isUrlOk(
    `https://api.github.com/repos/jungvonmatt/karate-kit/contents/examples/${encodeURIComponent(
      name
    )}/package.json`
  )
}
...
export function downloadAndExtractExample(
  ...
  return pipeline(
    got.stream('https://codeload.github.com/jungvonmatt/karate-kit/tar.gz/canary'),
